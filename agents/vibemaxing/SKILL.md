...
# 🧬 VibeMaxing Design Intelligence
...
```bash
python agents/vibemaxing/scripts/search.py "crypto trading dashboard" --design-system -p "VibeCrypto" --format markdown
```
...
```bash
python agents/vibemaxing/scripts/search.py "fitness SaaS app" --design-system -p "FitVibe" --persist --output-dir "."
```
...
```bash
python agents/vibemaxing/scripts/search.py "pricing cards" --design-system -p "FitVibe" --persist --page "pricing" --output-dir "."
```
...
```bash
# Query UI Styles
python agents/vibemaxing/scripts/search.py "glassmorphism" --domain style

# Query Fonts
python agents/vibemaxing/scripts/search.py "serif elegance" --domain typography

# Query Stack Guidelines
python agents/vibemaxing/scripts/search.py "performance optimization" --stack react
```
...
1. **Recon & Ingest**: Run `python agents/vibemaxing/scripts/search.py "<project niche>" --design-system -p "<ProjectName>"`
